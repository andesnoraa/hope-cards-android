...
PHOTOS=[
 ...
 ('misty-bend','pexels-timberly-hawkins-157463692-35000116.jpg',.85,'psalm-147-3','He heals','caveatbrush',dict(centerX=420,centerY=510,height=420,width=720,ink='#FFF8E9',citationInk='#FFF8E9')),
...
# Retired user-rejected sources must not remain packaged or reappear after import.
for retired in ('photo-foggy-pines', 'photo-teal-bark'):
 (OUT/'backgrounds'/(retired+'.webp')).unlink(missing_ok=True)
...
families={
 ...
 'forest':['forest-mist','forest-road','misty-bend'],
 'foliage':['shadow-ivy'], 'wildlife':['woodland-deer'],
 'coast':['shore-waves','coastal-dawn'], 'wood':['tree-bokeh','quiet-branch'],
