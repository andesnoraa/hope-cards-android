...
class VerseArtCatalogTest {
    @Test fun sixCategoriesHaveThirtyDistinctVersesEach() {
        ...
        assertEquals(180, categorized.size)
    ...
    @Test fun savedArtworkUsesExistingVerseFavorites() {
        ...
        assertEquals(180, VerseArtCatalog.inCategory(VerseArtCatalog.ALL, emptySet()).size)
    }
}
