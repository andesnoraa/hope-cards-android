...
val ClassicHopeColors = HopeColors(color(0xF8F6F2), color(0xF7F5F1), Color.White, color(0x1A2747), color(0x777777), color(0x8C93A3), color(0xC89B3C), color(0xF5EAC8), color(0xE7D7B2), color(0xE7E2D8), color(0xF8F6F2), color(0x1A2747), color(0xF8F6F2), color(0xC89B3C), color(0x273043), color(0x7A8292), color(0x1A2747), color(0xC89B3C), Color.White, color(0xC0392B), color(0xD9D9D9), color(0xE5EAF3))
